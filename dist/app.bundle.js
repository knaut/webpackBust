...
function printMe() {
  console.log('iam logged from printjs!');
}
...
module.exports = __webpack_require__.p + "e99d47b9ce3b62168b2e3be74eb16afb.png";
...
function component() {
  ...
  element.innerHTML = __WEBPACK_IMPORTED_MODULE_0_lodash___default.a.join(['Hello', 'webpack', 'and in the world'], ' ');
